...
**Google and UCP** focus on commerce and a standard language for discovery through checkout. [Google's Universal Commerce Protocol](https://developers.google.com/pay/api/universal-commerce-protocol/overview){:target="_blank" rel="noopener noreferrer"} describes that broader journey, while [Google's AP2 and UCP overview](https://codelabs.developers.google.com/next26/adk-agent-commerce){:target="_blank" rel="noopener noreferrer"} explains how authorization and commerce layers fit together.
